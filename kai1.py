...
def wishMe():
    ...
    if hour>=0 and hour<12:
        speak("Good Morning, I am KAI. Your Study companion!")

    elif hour>=12 and hour <=18:
        speak("Good Afternoon,  I am KAI. Your Study companion!")

    else:
        speak("Good Evening,  I am KAI. Your Study companion!")
...
def WhatsAppCall(name):
    os.startfile("C:\\Users\\VANSHKA\\AppData\\Local\\WhatsApp\\WhatsApp.exe")
    sleep(10)
    pyautogui.click(x=203, y=138)
    sleep(1)
    keyboard.write(name)
...
def Task_doing():
    ...
    #wishing command
        if 'hello' in query or 'hey' in query:
            ...
            Speak("My name is KAI. I am your study companion")
    ...
    #open app function
            ...
            Speak("ok. opening")
            os.startfile("C:\\Users\\VANSHIKA\\AppData\\Local\\WhatsApp")
